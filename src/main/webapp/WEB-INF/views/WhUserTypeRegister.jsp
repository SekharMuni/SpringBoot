...
<title>WhUserType RegisterPage</title>
<style type="text/css">
.error{
color:red
}
...
<body>
<h1>Welcome To WhUserType RegisterPage!!! </h1>
...
<input type="submit" value="Udate User">
</pre>
</form:form>
<br>
${message}
<h1><a href="getAllWhUserType">Get All WhUserType</a></h1>
</body>
</html>